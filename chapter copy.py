...
-------------------------
 ...
 |  | Management Team | 13
 |  | Year-in-Review | 14
 |  | 2023 At A Glance | 16# Example: Combining text and tables from two chapters
book_knowledge = """
Book name Annual report 2023
[page 1]
Table of Contents
...
Box 4.1: The Smart Stabilization System: ( chapter 4)
...
Box 4.2: Key Features of the Islamic Finance AI Assistant:  (chapter 4)
...
This is part of a series in which the winnerss the Islamic Finance Grants Projects completed in 2023
...
def main():
    ...
    while True:
        ...
        final_answer = ask_model(question,chapters,True)
